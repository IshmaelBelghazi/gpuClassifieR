...
```{r is, echo=FALSE, results='asis', eval=FALSE}
...
```{r oos, echo=FALSE, results='asis', eval=FALSE}
...
```{r benchplot, echo=FALSE, results="hide", fig.width=14, fig.height=8, eval=FALSE}
...
```{r compareplot, results="hide",echo=FALSE, eval=FALSE}
